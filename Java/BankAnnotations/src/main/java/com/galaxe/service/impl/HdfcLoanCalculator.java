...
public class HdfcLoanCalculator implements LoanCalculator{
	@PostConstruct
	void init() {
		System.out.println("HdfcLoanCalculator Initialised.....");
	}
	@Autowired
PropertyConfig propertyConfig;
	...
	@PreDestroy()
	void destroy() {
		System.out.println("HdfcLoanCalculator Closed.....");
	}
